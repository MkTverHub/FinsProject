...
public interface FinancedataRepository extends JpaRepository<AggrFinsdata, Integer> {
    ...
    @Query(value = "SELECT \n" +
            ...
            "case when t1.fins_oper_type = 'expense' then t2.name else case when t1.fins_oper_type = 'profit' then cnt_in.first_name else cnt_in.first_name end end payaccin_name, t1.pay_acc_out as payaccout,cnt_out.first_name as payaccout_name,\n" +
